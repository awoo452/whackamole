...
### Changed
- Refactored bowl fill logic to apply a single, deterministic visual state.
- Centralized interval cleanup into a single `stopGame()` helper.
- Simplified ingredient spawn logic by using a single class list and random pick.
